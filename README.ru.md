...
<img src="docs/github/screenshots/public-website.webp" width="100%" alt="Оформленный снимок публичного сайта JURO">

**Публичная точка входа — LIVE.** Начните на [juro.uz](https://juro.uz) с юридической ситуации, документа или следующего действия.

| Защищённое рабочее пространство | Документный workflow |
|---|---|
| <img src="docs/github/screenshots/platform-dashboard.webp" alt="Оформленный снимок защищённого пространства JURO без данных аккаунта" width="100%"> | <img src="docs/github/screenshots/document-builder.webp" alt="Оформленный снимок документного workflow JURO" width="100%"> |
| Свяжите юридическую ситуацию с защищённым рабочим пространством. | Начните структурированный черновик и продолжайте работу с документом. |

| Вход в юридическую информацию | Поверхность review и сравнения |
|---|---|
| <img src="docs/github/screenshots/ai-chat.webp" alt="Оформленный начальный экран юридической информации JURO без данных диалога" width="100%"> | <img src="docs/github/screenshots/document-analysis.webp" alt="Оформленный снимок review и сравнения документов JURO" width="100%"> |
| Начните с контекста: карточки источников появятся только при наличии подтверждений. | Интерфейс review и сравнения существует; end-to-end статус юридического анализа остаётся PARTIAL. |

> Предыдущий узкий снимок удалён из публичной презентации: он не соответствовал стандарту responsive-QA JURO. Он вернётся только после появления проверенного мобильного снимка.
