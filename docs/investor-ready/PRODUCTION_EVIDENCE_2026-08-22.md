...
- Platform: production build/artifact and performance budgets passed; rendered HTML 33/33, core 1064/1064, Cloudflare 201/201, the earlier focused set 28/28, call-focused set 5/5, marketplace lifecycle 19/19, admin-domain 10/10 and post-`0155` audit/config set 15/15 passed; type-check and lint passed. GitHub CI run `32590367331` passed both Platform and Website jobs at branch commit `4751d3c7` after the administrator profile-access fix.
