...
4. Re-list the production migration ledger and apply only the reviewed pending
   migrations shown for the release SHA. Never reuse a historical fixed range;
   the `2026-08-25` release applied only
   `0159_signed_share_verification_guard.sql`.
