...
export default async function LawyerProfilePage({ params }: Props) {
  ...
  return <div className={styles.page} lang={locale}><SiteHeader languageHref={`/${locale === "ru" ? "uz" : "ru"}/lawyers/${profileId}`} locale={locale} /><main id="main-content"><article className={styles.profile}>
