...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Legal Centre", description: "English navigation for JURO’s published legal documents, with links to the Russian and Uzbek originals.", url: "https://juro.uz/en/legal", siteName: "JURO", type: "website", images: [{ url: "/juro-og.png", width: 1681, height: 909, alt: "JURO Legal Centre" }] },
  twitter: { card: "summary_large_image", title: "Legal Centre", description: "English navigation for JURO’s published legal documents, with links to the Russian and Uzbek originals.", images: ["/juro-og.png"] },
};
...
export default function EnglishLegalCenter() {
  return <div className={styles.page} lang="en">
    ...
    <main id="main-content" tabIndex={-1}><section className={styles.hero}><p className={styles.eyebrow}>JURO · LEGAL CENTRE</p><h1>Find the published legal documents</h1><p>English navigation and document summaries are provided for orientation. The published Russian and Uzbek originals are the available legal texts; no English legal translation is represented here.</p><aside className={styles.previewNotice}><strong>Source-language originals</strong><span>Choose a document to see its scope and open the Russian or Uzbek published original.</span></aside></section>
