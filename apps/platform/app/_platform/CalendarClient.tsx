...
const labels = {
  ru: { title: "Календарь", subtitle: "Сроки из планов и подтверждённых задач текущего пространства.", month: "Месяц", week: "Неделя", list: "Список", cases: "По делам", overdue: "Просрочено", previous: "Назад", next: "Вперёд", loading: "Загружаем сроки…", empty: "В этом периоде нет активных сроков.", overdueEmpty: "Просроченных сроков нет.", open: "Открыть план дела", task: "Задача", step: "Шаг плана", weekdays: ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс"] },
  uz: { title: "Kalendar", subtitle: "Joriy makondagi reja va tasdiqlangan vazifalardan muddatlar.", month: "Oy", week: "Hafta", list: "Ro‘yxat", cases: "Ishlar bo‘yicha", overdue: "Kechikkan", previous: "Orqaga", next: "Keyingi", loading: "Muddatlar yuklanmoqda…", empty: "Bu davrda faol muddatlar yo‘q.", overdueEmpty: "Kechikkan muddatlar yo‘q.", open: "Ish rejasini ochish", task: "Vazifa", step: "Reja qadami", weekdays: ["Du", "Se", "Ch", "Pa", "Ju", "Sh", "Ya"] },
} as const;
...
export function CalendarClient({ locale }: { locale: "ru" | "uz" }) {
  ...
  const shift = (direction: -1 | 1) => setAnchor((current) => addCalendarDays(current, view === "week" ? direction * 7 : direction * 31));
