...
function invalidInputResponse(
  error: "invalid_content_type" | "invalid_json" | "invalid_input" | "payload_too_large",
) {
...
function confirmationError(
  result: Exclude<DeletionConfirmationResult, {
    status: "confirmed";
  }>,
  locale: "ru" | "uz",
): Response {
  ...
  > = {
    invalid: [400, "DELETION_CODE_INVALID", "Проверка недействительна.", "Tekshiruv yaroqsiz."],
    used: [409, "DELETION_CODE_USED", "Этот код уже использован.", "Bu kod allaqachon ishlatilgan."],
    replaced: [400, "DELETION_CODE_REPLACED", "Код заменён новым. Используйте последнее письмо.", "Kod yangisi bilan almashtirilgan. Oxirgi xatdan foydalaning."],
    expired: [400, "DELETION_CODE_EXPIRED", "Срок действия кода истёк.", "Kod muddati tugagan."],
    attempts_exceeded: [429, "DELETION_ATTEMPTS_EXCEEDED", "Попытки закончились. Запросите новый код.", "Urinishlar tugadi. Yangi kod so‘rang."],
    incorrect: [400, "DELETION_CODE_INCORRECT", "Неверный код.", "Kod noto‘g‘ri."],
  };
