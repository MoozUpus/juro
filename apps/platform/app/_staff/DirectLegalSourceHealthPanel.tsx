...
const copy = {
  ru: {
    eyebrow: "Query-scoped direct retrieval", title: "Состояние официальных источников", description: "Проверка касается только доступности robots endpoints. Страницы законов и сценариев не сохраняются.", check: "Проверить сейчас", fresh: "Источники доступны", degraded: "Один или несколько источников недоступны", stale: "Проверка устарела", unknown: "Проверка ещё не запускалась", last: "Последняя проверка", latency: "Задержка", unavailable: "Защищённый status сейчас недоступен.", never: "нет данных", noAlert: "Активных предупреждений нет", alert: "Требуется проверка источника",
  },
  uz: {
    eyebrow: "So‘rov doirasidagi bevosita olish", title: "Rasmiy manbalar holati", description: "Tekshiruv faqat robots endpointlari mavjudligini ko‘rsatadi. Qonun va ssenariy sahifalari saqlanmaydi.", check: "Hozir tekshirish", fresh: "Manbalar mavjud", degraded: "Bir yoki bir nechta manba mavjud emas", stale: "Tekshiruv eskirgan", unknown: "Tekshiruv hali boshlanmagan", last: "Oxirgi tekshiruv", latency: "Kechikish", unavailable: "Himoyalangan holat hozir mavjud emas.", never: "ma’lumot yo‘q", noAlert: "Faol ogohlantirish yo‘q", alert: "Manbani tekshirish kerak",
  },
} as const;
