...
import { AuditLogConsole } from "../../../_staff/AuditLogConsole";
...
export default async function AuditLogPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  try {
    ...
    await requirePlatformStaffAccess(runtime.DB, session, "staff.security.audit", {
      now,
    ...
    return <AdminConsoleAccess
      ...
      returnTo={`/${locale}/admin/audit-log`}
    />;
  }
  return <AuditLogConsole locale={locale} staffName={staffName}/>;
}
