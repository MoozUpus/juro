...
export default async function BusinessDocumentEdit({ params, searchParams }: { params: Promise<{ locale: string; workspaceId: string; id: string }>; searchParams: Promise<Query> }) {
  ...
  await requireChatGPTUser(`${base}/documents/${encodeURIComponent(id)}/edit`);
