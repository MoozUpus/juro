...
async function databaseFixture(status: string, fileKind: string) {
  ...
  sqlite.exec(`
    ...
    CREATE TABLE document_risks (id TEXT PRIMARY KEY,analysis_id TEXT NOT NULL,level TEXT NOT NULL,title TEXT NOT NULL,description TEXT NOT NULL,excerpt TEXT,confidence_percent INTEGER,created_at TEXT NOT NULL);
