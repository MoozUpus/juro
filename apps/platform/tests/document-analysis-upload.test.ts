...
function uploadDatabase() {
  ...
  sqlite.exec(`
    ...
    CREATE TABLE document_analyses (id TEXT PRIMARY KEY,workspace_id TEXT NOT NULL,owner_user_id TEXT NOT NULL,uploaded_file_id TEXT NOT NULL UNIQUE,case_id TEXT,case_link_revision INTEGER NOT NULL DEFAULT 0,case_linked_by_user_id TEXT,status TEXT NOT NULL,summary_json TEXT,error_code TEXT,consent_version TEXT NOT NULL,created_at TEXT NOT NULL,updated_at TEXT NOT NULL,FOREIGN KEY(workspace_id) REFERENCES workspaces(id),FOREIGN KEY(owner_user_id) REFERENCES user_profiles(id),FOREIGN KEY(uploaded_file_id) REFERENCES document_files(id));
