-- Migration 0084: append-only operational feature switches with tamper-evident history.
CREATE TABLE `operational_feature_flag_versions` (
	...
	CONSTRAINT `operational_feature_key_check` CHECK (`feature_key` IN ('ai_chat','document_analysis_upload','lawyer_handoff','voice_mode')),
