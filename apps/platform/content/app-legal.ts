...
const sharedRu = {
  operator: "Оператор платформы: ООО «JURO» (также MChJ «JURO» / «JURO» LLC), публичный контакт: admin@juro.uz, адрес: Tashkent, Uzbekistan.",
...
const sharedUz = {
  operator: "Platforma operatori: «JURO» MChJ (shuningdek ООО «JURO» / «JURO» LLC), ommaviy aloqa: admin@juro.uz, manzil: Tashkent, Uzbekistan.",
  ...
  uz: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "4. Foydalanuvchi huquqlari", paragraphs: ["Sozlamalarda metadata eksporti, roziliklar tarixi va o‘chirish so‘rovi mavjud. Ayrim ma’lumotlar majburiy muddat davomida saqlanishi mumkin.", "Murojaat yoki shikoyat uchun admin@juro.uz manzilidan foydalaning."] },
      ],
    },
    cookies: {
