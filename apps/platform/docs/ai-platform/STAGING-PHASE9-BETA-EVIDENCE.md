...
- version: `cfef8153-3322-4ce5-b271-3478a0531b28` at 100% traffic;
- source: `8cb9fea`;
...
|---|---|---|
| Exact deployment | Pass | Version/deployment read-back at 100% |
...
| Anonymous isolation | Pass | Prototype, RU, UZ, and builder routes redirect to Access |
| Production Worker invariant | Pass | `juro` remains `91774ed4-72e9-47bb-b93a-a4208d490b24` |
| Local regression | Pass | 416/416 plus type-check, lint, builds, artifacts, smokes |
...
| Real AI providers | Blocked | OpenAI/Anthropic secret bindings are absent |
