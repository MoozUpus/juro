...
- 254 core/auth/document tests;
- 72 Cloudflare/migration/job tests, including migrations `0029`–`0030`, encrypted security-email evidence, periodic session rotation, and queue concurrency/replay contracts;
- 353 tests total.
