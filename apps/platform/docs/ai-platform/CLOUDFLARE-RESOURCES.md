...
> Current checkpoint — 2026-07-31: `juro-staging` has 41 migrations through `0040`; `juro-platform-staging` version `c985f6a3-d7b8-408d-a2dd-8952ece98e47` serves 100% behind Access with five consumers (document analysis, document export, legal sources, email, retention) and one five-minute cron. Analysis exports have R2-first terminal deletion and account-deletion continuity. Staging has no eligible completed analysis. Production Worker `juro` remains `91774ed4-72e9-47bb-b93a-a4208d490b24`. This supersedes older current-state summaries below; their historical resource IDs remain evidence of earlier checkpoints.
