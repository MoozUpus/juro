...
then apply and repeat integrity/export checks. Rollback is application-first:
restore the prior Worker and leave the additive fields unused. Production is not
authorized.
