/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: 1451e6aac8d7e3c9053b6370025e3e14)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	LEGAL_RU_INDEX: VectorizeIndex;
	LEGAL_UZ_INDEX: VectorizeIndex;
	INTERNAL_LEGAL_INDEX: VectorizeIndex;
	USER_MEMORY_INDEX: VectorizeIndex;
	PLATFORM_ANALYTICS: AnalyticsEngineDataset;
	AI_JOBS_QUEUE: Queue;
	FILE_JOBS_QUEUE: Queue;
	DOCUMENT_JOBS_QUEUE: Queue;
	LEGAL_SYNC_QUEUE: Queue;
	EMAIL_JOBS_QUEUE: Queue;
	NOTIFICATION_JOBS_QUEUE: Queue;
	CLEANUP_JOBS_QUEUE: Queue;
	BACKUP_JOBS_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ASYNC_RUNTIME_ENABLED" | "CRON_ENABLED" | "IDENTITY_PROTECTION_MODE" | "JOB_SCHEMA_VERSION" | "EMAIL_FROM">> {}
}
