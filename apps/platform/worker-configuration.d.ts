/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: b42b1f774a7fa42f8feb5f4a51d5e653)
// Runtime types generated with workerd@1.20260828.1 2026-07-26 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	ASYNC_RUNTIME_ENABLED: "true" | "false";
	CRON_ENABLED: "true" | "false";
	ACCOUNT_DELETION_PURGE_ENABLED: "true" | "false";
	MALWARE_SCAN_ENABLED?: "true";
	MALWARE_SCANNER_PROBE_ENABLED?: "false";
	STAGING_DOCUMENT_ANALYSIS_PROBE_ENABLED?: "false";
	GUEST_AI_ENABLED: "true";
	STAGING_SYNTHETIC_PROBES_ENABLED: "true" | "false";
	STAGING_LEGAL_EVALUATION_ENABLED?: "true" | "false";
	STAGING_QUEUE_HEALTH_PROBE_ENABLED: "true" | "false";
	PRODUCTION_SYNTHETIC_PROBES_ENABLED: "false" | "true";
	PUBLIC_DOCUMENT_URL_IMPORT_ENABLED: "false";
	PAYMENT_FOUNDATION_ENABLED: "true";
	PAYMENT_SANDBOX_ENABLED: "true" | "false";
	PAYMENT_PRODUCTION_APPROVED: "false";
	PAYMENT_PRODUCTION_DEMO_ENABLED: "true";
	LEGAL_LEX_INGESTION_ENABLED: "true" | "false";
	...
	LEGAL_ADVICE_SITEMAP_DISCOVERY_ENABLED: "false";
	LEGAL_LEX_RSS_DISCOVERY_ENABLED: "true";
	LEGAL_SOURCE_STAFF_API_ENABLED: "false";
	LAWYER_PROFILE_DIRECTORY_ENABLED: "true";
	...
	STATUS_HOSTNAME: "status.staging.juro.uz" | "status.juro.uz" | "status.localhost";
	ADMIN_CONSOLE_ORIGIN?: "https://admin.staging.juro.uz" | "https://admin.juro.uz";
	...
	MALWARE_SCANNER_CONTAINER?: DurableObjectNamespace<import("./worker/index").MalwareScannerContainer>;
	QDRANT_CONTAINER?: DurableObjectNamespace<import("./worker/index").LegalCorpusQdrantContainer>;
	MALWARE_SCANNER?: Fetcher /* juro-platform-staging */ | Fetcher /* juro */;
	LEGAL_CORPUS_READ_SERVICE: Fetcher /* juro-legal-corpus-staging */ | Fetcher /* juro-legal-corpus */ | Fetcher /* juro-legal-corpus-development */;
	PRODUCTION_QUEUE_HEALTH_PROBE_QUEUE?: Queue;
	TURNSTILE_SITE_KEY?: "0x4AAAAAAEJG7au8PVCt7Euq";
	PRODUCTION_QUEUE_HEALTH_PROBE_ENABLED?: "true";
	ADMIN_CONSOLE?: Fetcher /* juro-admin */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		EMAIL_FROM: "JURO <no-reply@juro.uz>";
		OPERATIONS_ALERT_EMAIL: "muzaffarbekmurodoff@gmail.com";
		STATUS_HOSTNAME: "status.staging.juro.uz";
		ADMIN_CONSOLE_ORIGIN: "https://admin.staging.juro.uz";
		OPENAI_CHAT_MODEL: "gpt-5.6-terra";
		OPENAI_RETRIEVAL_MODEL: "gpt-5.6-terra";
		OPENAI_RERANK_MODEL: "text-embedding-3-large";
		LEGAL_RERANKER_VERSION: "provision-set-v1";
		...
		MALWARE_SCANNER_CONTAINER: DurableObjectNamespace<import("./worker/index").MalwareScannerContainer>;
		QDRANT_CONTAINER: DurableObjectNamespace<import("./worker/index").LegalCorpusQdrantContainer>;
		MALWARE_SCANNER: Fetcher /* juro-platform-staging */;
		LEGAL_CORPUS_READ_SERVICE: Fetcher /* juro-legal-corpus-staging */;
	}
	interface ProductionEnv {
		...
		STAGING_LEGAL_EVALUATION_ENABLED: "false";
		...
		ADMIN_CONSOLE_ORIGIN: "https://admin.juro.uz";
		MALWARE_SCANNER_CONTAINER: DurableObjectNamespace<import("./worker/index").MalwareScannerContainer>;
		MALWARE_SCANNER: Fetcher /* juro */;
		ADMIN_CONSOLE: Fetcher /* juro-admin */;
		LEGAL_CORPUS_READ_SERVICE: Fetcher /* juro-legal-corpus */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ASYNC_RUNTIME_ENABLED" | "CRON_ENABLED" | "ACCOUNT_DELETION_PURGE_ENABLED" | "MALWARE_SCAN_ENABLED" | "MALWARE_SCANNER_PROBE_ENABLED" | "STAGING_DOCUMENT_ANALYSIS_PROBE_ENABLED" | "GUEST_AI_ENABLED" | "STAGING_SYNTHETIC_PROBES_ENABLED" | "STAGING_LEGAL_EVALUATION_ENABLED" | "STAGING_QUEUE_HEALTH_PROBE_ENABLED" | "PRODUCTION_SYNTHETIC_PROBES_ENABLED" | "PUBLIC_DOCUMENT_URL_IMPORT_ENABLED" | "PAYMENT_FOUNDATION_ENABLED" | "PAYMENT_SANDBOX_ENABLED" | "PAYMENT_PRODUCTION_APPROVED" | "PAYMENT_PRODUCTION_DEMO_ENABLED" | "LEGAL_LEX_INGESTION_ENABLED" | "LEGAL_LEX_METADATA_MONITOR_ENABLED" | "LEGAL_ADVICE_INGESTION_ENABLED" | "LEGAL_DIRECT_RETRIEVAL_ENABLED" | "LEGAL_CORPUS_ENABLED" | "LEGAL_CORPUS_LIVE_LEXUZ_ENABLED" | "LEGAL_CORPUS_AUTO_INGEST_ENABLED" | "LEGAL_CORPUS_MULTILINGUAL_ENABLED" | "LEGAL_CORPUS_OWNER_UPLOAD_AUTO_TRUST" | "LEGAL_CORPUS_USER_UPLOAD_AUTO_TRUST" | "LEGAL_CORPUS_HISTORICAL_ENABLED" | "LEGAL_CORPUS_DENSE_ENABLED" | "LEGAL_CORPUS_SHADOW_MODE" | "LEGAL_ADVICE_SITEMAP_DISCOVERY_ENABLED" | "LEGAL_LEX_RSS_DISCOVERY_ENABLED" | "LEGAL_SOURCE_STAFF_API_ENABLED" | "LAWYER_PROFILE_DIRECTORY_ENABLED" | "IDENTITY_PROTECTION_MODE" | "JOB_SCHEMA_VERSION" | "EMBEDDING_MODEL" | "EMAIL_FROM" | "OPERATIONS_ALERT_EMAIL" | "STATUS_HOSTNAME" | "ADMIN_CONSOLE_ORIGIN" | "OPENAI_CHAT_MODEL" | "OPENAI_RETRIEVAL_MODEL" | "OPENAI_RERANK_MODEL" | "LEGAL_RERANKER_VERSION" | "OPENAI_DEEP_MODEL" | "OPENAI_TRANSCRIPTION_MODEL" | "OPENAI_TTS_MODEL" | "ANTHROPIC_DOCUMENT_MODEL" | "ANTHROPIC_FALLBACK_MODEL" | "QDRANT_URL" | "QDRANT_COLLECTION" | "TURNSTILE_SITE_KEY" | "PRODUCTION_QUEUE_HEALTH_PROBE_ENABLED">> {}
}
