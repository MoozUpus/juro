/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: 22280514d7face0d224071bdbd0055aa)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ASYNC_RUNTIME_ENABLED" | "CRON_ENABLED" | "LEGAL_ADVICE_INGESTION_ENABLED" | "LEGAL_SOURCE_STAFF_API_ENABLED" | "IDENTITY_PROTECTION_MODE" | "JOB_SCHEMA_VERSION" | "EMAIL_FROM">> {}
}
