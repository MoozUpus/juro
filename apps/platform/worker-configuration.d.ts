/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: c51c80d1d43eb66e81a81dbf67fe0eea)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ASYNC_RUNTIME_ENABLED" | "CRON_ENABLED" | "ACCOUNT_DELETION_PURGE_ENABLED" | "STAGING_SYNTHETIC_PROBES_ENABLED" | "LEGAL_ADVICE_INGESTION_ENABLED" | "LEGAL_SOURCE_STAFF_API_ENABLED" | "IDENTITY_PROTECTION_MODE" | "JOB_SCHEMA_VERSION" | "EMAIL_FROM">> {}
}
