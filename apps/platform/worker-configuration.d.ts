/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: 7055df84e3aedfe4c2f6e164666e0bf0)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ASYNC_RUNTIME_ENABLED" | "CRON_ENABLED" | "LEGAL_ADVICE_INGESTION_ENABLED" | "IDENTITY_PROTECTION_MODE" | "JOB_SCHEMA_VERSION" | "EMAIL_FROM">> {}
}
