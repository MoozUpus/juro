/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: 78fd20b37bfc4d471316f432b3afaaf3)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ASYNC_RUNTIME_ENABLED" | "CRON_ENABLED" | "ACCOUNT_DELETION_PURGE_ENABLED" | "STAGING_SYNTHETIC_PROBES_ENABLED" | "LEGAL_ADVICE_INGESTION_ENABLED" | "LEGAL_ADVICE_SITEMAP_DISCOVERY_ENABLED" | "LEGAL_SOURCE_STAFF_API_ENABLED" | "LAWYER_PROFILE_DIRECTORY_ENABLED" | "IDENTITY_PROTECTION_MODE" | "JOB_SCHEMA_VERSION" | "EMBEDDING_MODEL" | "EMAIL_FROM" | "OPENAI_CHAT_MODEL" | "OPENAI_DEEP_MODEL" | "ANTHROPIC_DOCUMENT_MODEL" | "ANTHROPIC_FALLBACK_MODEL">> {}
}
