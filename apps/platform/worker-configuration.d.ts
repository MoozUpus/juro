/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: a1e2fe683f566b2ac26892682648f6fe)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ASYNC_RUNTIME_ENABLED" | "CRON_ENABLED" | "ACCOUNT_DELETION_PURGE_ENABLED" | "MALWARE_SCAN_ENABLED" | "MALWARE_SCANNER_PROBE_ENABLED" | "STAGING_DOCUMENT_ANALYSIS_PROBE_ENABLED" | "GUEST_AI_ENABLED" | "STAGING_SYNTHETIC_PROBES_ENABLED" | "PAYMENT_FOUNDATION_ENABLED" | "PAYMENT_SANDBOX_ENABLED" | "PAYMENT_PRODUCTION_APPROVED" | "LEGAL_ADVICE_INGESTION_ENABLED" | "LEGAL_DIRECT_RETRIEVAL_ENABLED" | "LEGAL_ADVICE_SITEMAP_DISCOVERY_ENABLED" | "LEGAL_LEX_RSS_DISCOVERY_ENABLED" | "LEGAL_SOURCE_STAFF_API_ENABLED" | "LAWYER_PROFILE_DIRECTORY_ENABLED" | "IDENTITY_PROTECTION_MODE" | "JOB_SCHEMA_VERSION" | "EMBEDDING_MODEL" | "EMAIL_FROM" | "OPERATIONS_ALERT_EMAIL" | "STATUS_HOSTNAME" | "ADMIN_CONSOLE_ORIGIN" | "OPENAI_CHAT_MODEL" | "OPENAI_DEEP_MODEL" | "OPENAI_TRANSCRIPTION_MODEL" | "OPENAI_TTS_MODEL" | "ANTHROPIC_DOCUMENT_MODEL" | "ANTHROPIC_FALLBACK_MODEL" | "TURNSTILE_SITE_KEY">> {}
}
