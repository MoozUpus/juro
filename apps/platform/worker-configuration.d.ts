/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.jsonc` (hash: b4b7b2631eae874087416a322cc2b407)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ASYNC_RUNTIME_ENABLED" | "CRON_ENABLED" | "ACCOUNT_DELETION_PURGE_ENABLED" | "LEGAL_ADVICE_INGESTION_ENABLED" | "LEGAL_SOURCE_STAFF_API_ENABLED" | "IDENTITY_PROTECTION_MODE" | "JOB_SCHEMA_VERSION" | "EMAIL_FROM">> {}
}
