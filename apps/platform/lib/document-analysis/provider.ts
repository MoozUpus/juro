...
type SafeDocumentAnalysisProviderFailure = {
  ...
  errorCode: "PROVIDER_UNAVAILABLE" | "PROVIDER_TIMEOUT" | "INVALID_AI_OUTPUT" | "PROVIDER_CIRCUIT_OPEN" | "AI_COST_BUDGET_EXHAUSTED" | "AI_REFUSED" | "AI_CANCELLED" | "ANTHROPIC_PREFLIGHT_FAILED" | "ANTHROPIC_REQUEST_FAILED" | "ANTHROPIC_POSTPROCESS_FAILED";
